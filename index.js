...
exports.dialogflowFirebaseFulfillment = functions.https.onRequest((request, response) => {
  ...
  const actionHandlers = {
    'ramalan_cuaca' : () => {
        ...
        const endpoint = "/data/2.5/weather?APPID=c0953e2b19be61f15c05ae0f072c7d6c&units=metric&q=";
        const kota = parameters['geo-city'];
        let path = endpoint + kota;
